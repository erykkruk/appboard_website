...
const BLOG_DESCRIPTION =
  "Artículos prácticos sobre ASO en español: Google Play Console, App Store Connect, posicionamiento ASO y lo que cuesta de verdad en España.";
...
export default function BlogPlPage(): JSX.Element {
  const articles = [...BLOG_ARTICLES_ES].sort((a, b) =>
        ...
        <section className="px-4 pb-10 pt-20 sm:px-6 sm:pt-28">
          <div className="mx-auto max-w-3xl">
            ...
            <h1 className="display mt-4 text-5xl text-foreground sm:text-6xl">
              Publicar apps y hacerlas visibles
            </h1>
            <p className="mt-5 text-lg leading-relaxed text-muted">
              Guías de Google Play Console y App Store Connect, posicionamiento ASO y costes reales en el mercado español. Todas las cifras verificadas en la fuente, en Apple y Google.
            </p>
